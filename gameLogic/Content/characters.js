...
module.exports=class characters {
    constructor(StoryEvent) {
        ...
        this.characters={
            ...
            town: [
                new entity({name: "Friendly cat", desc: "an adorable cat", speechType: 'cat', job: jobs.Test_Enemy, max_hp: 10000, level: 100, stats: {str: 99}}),
            ...
            cave: [
                ...
                new entity({name: "Harmless Bunny", desc: "an adorable little bunny", hostility: true, job: jobs.Test_Enemy, speechType: 'dragon', max_hp: 10000, level: 100, stats: {str: 99, agi: 99}}),
                new entity({name: "Smorf", desc: "a small orange goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 10, level: 1}),
                new entity({name: "Smyrf", desc: "a small yellow goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 20, level: 2}),
                new entity({name: "Smeeg", desc: "a small green goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 30, level: 3}),
            ...
            deep_cave: [
                ...
                new entity({name: "Smoob", desc: "a small blue goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 40, level: 4}),
                new entity({name: "Smave", desc: "a small violet goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 50, level: 5}),
                new entity({name: "Smerf", desc: "a small red goblin with a sack of coins.", speechType: 'goblin', hostility: true, job: jobs.Test_Enemy, max_hp: 60, level: 6}),
                
            ],
            abandoned_castle: [
                new entity({name: "Elder Dragon", desc: "a dragon", speechType: 'dragon', hostility: true, job: jobs.Test_Enemy, max_hp: 1000, level: 30, stats: {str: 100, int: 100}}),
                new entity({name: "Giant Spider", desc: "a horrifying giant spider", hostility: true, job: jobs.Test_Enemy, speechType: 'spider', max_hp: 800, level: 15, stats: {str: 100}}),
            ...
            explore: [
                new entity({name: "Bandit", desc: "a big jerk face", speechType: 'general', hostility: true, job: jobs.Test_Enemy, max_hp: 300, level: 3, stats: {str: 100}}),
                new entity({name: "Friendly cat", desc: "an adorable cat", speechType: 'cat', job: jobs.Test_Enemy, max_hp: 10000, level: 100, stats: {str: 99}}),
                new entity({name: "Tiff", desc: "a queer cutie", speechType: 'tiff', job: jobs.Test_Enemy, max_hp: 10000, level: 100, stats: {str: 99}}),
            ],
            tavern: [
                new entity({name: "Friendly cat", desc: "an adorable cat", speechType: 'cat', job: jobs.Test_Enemy, max_hp: 10000, level: 100, stats: {str: 99}}),
